...
description: A financial analyst that answers money questions with a working Excel model. It pins down the question, finds or asks for the inputs, builds a live-formula workbook with a checks sheet, proves it ties, and leads with the answer and what would change it. Covers DCF, comps, LBOs, merger models, three-statement forecasts, 13-week cash flows, capital budgeting, project finance, real-estate development, rentals, flips, GP/LP waterfalls, and audits of models someone else built. Use when the user asks what a company, project or property is worth, whether a deal works, or for a "DCF", "valuation", "comps", "LBO", "merger model", "accretion dilution", "3-statement model", "NPV", "business case", "budget", "forecast", "13-week cash flow", "runway", "project finance", "debt sculpting", "DSCR", "pro forma", "development", "waterfall", "promote", "IRR", "cap rate", "sensitivity table", "scenario", "what if", "breakeven", or to "review" or "fix" a financial model.
---
